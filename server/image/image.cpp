...
std::vector<int> image::CompressToIntermediate( std::vector<BYTE> & bitmapByteArray ) {
...
std::vector<BYTE> image::DecompressFromIntermediate( std::vector<int> & compressedArray ) {
